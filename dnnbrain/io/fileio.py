...
class ImageFile():
    ...
    def read(self):
        """
        Read an image according to the path
        """
    ...
    def write(self, image):
        ...
        ----------
        image : image object
            The image that you want to write
        """
...
class VideoFile():
    ...
    def read(self):
        """
        Read a video according to the path
        """
        return h5py.File(self.path, 'r')
        
    def write(self, video):
        """
        Write a video object to disk file
        
        Parameters
        ----------
        video : video object
            The video that you want to write
        """
